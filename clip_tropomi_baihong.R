...
tmpdir          <- "/mnt/c/Rwork"
out_dir         <- "/mnt/g/TROPOMI/esa/extracted/baihong/us_ho2"
out_name        <- "/US_Ho2_TROPOSIF_L2B_"
...
notes           <- "This data has been filtered to include only soundings in area of US-Ho2"

### Polygons for clipping
roi_file       <- "/mnt/g/baihong/US_Ho2/US_Ho2.shp"
