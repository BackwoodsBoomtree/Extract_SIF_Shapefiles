...
tmpdir          <- "/mnt/c/Rwork"
out_dir         <- "/mnt/g/TROPOMI/esa/extracted/Africa/ecoregions"
...
notes           <- "This data has been filtered to include only EBF soundings in polygon with cloud fraction < 0.80"
